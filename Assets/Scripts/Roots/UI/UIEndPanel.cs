		...
		protected override void OnInit(IUIData uiData = null)
		{
			...
			switch (mData.Endings)
			{
				...
				case 6:
					...
					EndTitle.text = "九天玄仙";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("XIAN2");
					break;
				//fo1
				case 5:
					...
					EndTitle.text = "紫微帝君";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("XIAN1");
					break;
				//gui2
				case 4:
					EndDesc.text = "你以凡胎肉体踏入鬼仙之道，凡人死去后，灵魂变得混沌，紧接着就消散。但你成为了一个神志清晰，游荡世间的存在，不再拥有实体，冷漠的观察着世间的一切，直到永远…";
					EndTitle.text = "赤面鬼君";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("GUI2");
					break;
				case 3:
					...
					EndTitle.text = "白面鬼帝";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("GUI1");
					break;
				//xian
				case 2:
					EndDesc.text = "即使万千劫难加身，唯你心不可动摇，如山如石。无论世事如何变迁，山在你在。从此行走人世间普度众生，化解凡人疾苦。弹指挥间可感化妖邪，让人心无杂念。";
					EndTitle.text = "藏识罗汉";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("FO2");
					break;
				case 1:
					...
					EndTitle.text = "大须弥佛";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("FO1");
					break;
				//yao
				case 7:
					...
					EndTitle.text = "不灭妖灵";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("YAO2");
					break;
				case 8:
					EndDesc.text = "你以凡人之躯，替血换骨，成为山间精灵，获得百变之能。举手投足摄人心魂，能够蛊惑人心。从此人间再无难事，逍遥世间千万载。";
					EndTitle.text = "灵魅妖仙";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("YAO1");
					break;
				case 9:
					EndDesc.text = "元宵佳节之际";
					EndTitle.text = "正道飞升";
					EndImage.sprite = _resLoader.LoadSync<Sprite>("PUTONG");
					break;
